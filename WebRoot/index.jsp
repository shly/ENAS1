...
<body class="login">
	...
	<div class="content">
		...
		<form method="post" class="form-vertical login-form" action="userAction.login.action">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="password" placeholder="Password" name="password" required="required"/>
