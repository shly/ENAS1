...
<body class="page-header-fixed">
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					<form method="post" class="well form-inline" action="failureReportAction.findFailureReports.action" id="Form">
                       ...
                       <input type="hidden" value="0" id="currentpage">
					    <div>
							<ul class="pager">
								...
								<li>
									<a href="failureReportAction.findFailureReports.action" id="nextpage">下一页</a>
								</li>
								 <li id="total">
									 共0页
								</li>
	...
	<script src="js/cutpage_failurereport.js"></script>      
